    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="relative bg-white rounded-2xl w-full max-w-md shadow-lg overflow-hidden">
        ...
        <div className="bg-pink-600 text-white px-4 py-3 flex items-center justify-between">
          <h2 className="text-base font-semibold">Lý do ứng tuyển</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 max-h-[60vh] overflow-y-auto text-gray-700">
          <div className="mb-3">
            <h3 className="text-sm font-bold text-gray-800">
              {candidateName || 'Chưa cập nhật'} —{' '}
              <span className="font-semibold text-gray-600">
                {positionTitle || 'Chưa cập nhật'}
              </span>
            </h3>
          </div>
                ...
                {candidateAddress && (
                  <div className="col-span-2">
                    ...
                    <p className="text-gray-500 text-xs">
                      {candidateAddress || 'Chưa có địa chỉ'}
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="space-y-2 text-xs leading-relaxed">
            <div>
              ...
              <div 
                ...
                dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(applicationReason || 'Không có lý do ứng tuyển') }}
              />
            </div>
          </div>
        </div>
