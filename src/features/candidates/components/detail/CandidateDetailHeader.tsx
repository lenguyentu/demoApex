        ...
        <div className="min-w-0 flex-1">
              ...
              {candidate.applied_position && (
                <div className="mb-3">
                  <p className="text-sm text-gray-600 mb-1">
                    Desired position: <span className="font-semibold text-gray-900">{candidate.applied_position}</span>
                  </p>
                </div>
              )}
            </>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-4">
            ...
            {evaluation_file_path && (
              ...
              >
                <FileText className="h-4 w-4" />
                <span>View evaluation document</span>
              </button>
            )}
          </div>
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-gray-200 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                ...
                {statusDisplayName || 'Not updated'}
              </span>
            </div>
            {created_at && (
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-600">Applied date:</span>
