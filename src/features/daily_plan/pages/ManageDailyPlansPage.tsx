    ...
    <div className="p-8 bg-gray-50 min-h-screen">
       <div className="w-full">
         <div className="flex justify-between items-center mb-8">
           <div>
             <h1 className="text-2xl font-bold text-gray-800">Manage Daily Plans</h1>
             <p className="text-gray-500 mt-1">Track plan submission status and grant late submission exceptions.</p>
           </div>
           ...
           <table className="w-full text-left border-collapse">
             <thead>
               <tr className="bg-gray-50 border-b border-gray-200 text-sm uppercase tracking-wider">
                 ...
                 <th className="p-4 font-semibold text-gray-600 text-center">Exception Privilege (Late)</th>
               </tr>
             </thead>
             <tbody>
               {hhStatusList.map(h => (
